 ...
 (function ($, window, document, undefined) {
    ...
    GlassCase.prototype = {
        ...
        setup: function () {
            ...
            // THUMBS
            if (gcBase.config.isOneThumbShown == false && gcBase.gcTotalThumbsImg == 3) {
